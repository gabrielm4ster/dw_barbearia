...
import 'package:dw_barbearia/src/freatures/splash/auth/login/register/user/barbearia/barbearia_register_state.dart';
import 'package:dw_barbearia/src/freatures/splash/auth/login/register/user/barbearia/barbearia_register_vm.dart';
...
class _BarbeariaRegisterPageState
    extends ConsumerState<BarbeariaRegisterPage> {
  ...
  Widget build(BuildContext context) {
    final barbeariaRegisterVM =
        ref.watch(barbeariaRegisterVmProvider.notifier);
