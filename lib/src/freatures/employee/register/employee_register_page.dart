...
import 'package:dw_barbearia/src/freatures/employee/register/employee_register_state.dart';
import 'package:dw_barbearia/src/freatures/employee/register/employee_register_vm.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: barbeariaAsyncValue.when(
            ...
            data: (barbeariaModel) {
              final BarbeariaModel(:openingDays, :openingHours) =
                  barbeariaModel;
